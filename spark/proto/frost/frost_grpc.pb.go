...
const (
	...
	FrostService_PartialEcdh_FullMethodName               = "/frost.FrostService/partial_ecdh"
	FrostService_ThresholdDecryptReencrypt_FullMethodName = "/frost.FrostService/threshold_decrypt_reencrypt"
)
...
type FrostServiceClient interface {
	...
	// Each signer computes S_i = key_share_i * ephemeral_pubkey from the ECIES ciphertext.
	PartialEcdh(ctx context.Context, in *PartialEcdhRequest, opts ...grpc.CallOption) (*PartialEcdhResponse, error)
	// T-PRE: Combined threshold decrypt + re-encrypt operation.
	// Takes the partial ECDH shares from all operators, combines them via Lagrange
	// interpolation, decrypts the content key, and re-encrypts it to the reader's public key.
	ThresholdDecryptReencrypt(ctx context.Context, in *ThresholdDecryptReencryptRequest, opts ...grpc.CallOption) (*ThresholdDecryptReencryptResponse, error)
}
...
func (c *frostServiceClient) PartialEcdh(ctx context.Context, in *PartialEcdhRequest, opts ...grpc.CallOption) (*PartialEcdhResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PartialEcdhResponse)
	err := c.cc.Invoke(ctx, FrostService_PartialEcdh_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *frostServiceClient) ThresholdDecryptReencrypt(ctx context.Context, in *ThresholdDecryptReencryptRequest, opts ...grpc.CallOption) (*ThresholdDecryptReencryptResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ThresholdDecryptReencryptResponse)
	err := c.cc.Invoke(ctx, FrostService_ThresholdDecryptReencrypt_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FrostServiceServer interface {
	...
	// T-PRE: Compute partial ECDH for threshold proxy re-encryption.
	// Each signer computes S_i = key_share_i * ephemeral_pubkey from the ECIES ciphertext.
	PartialEcdh(context.Context, *PartialEcdhRequest) (*PartialEcdhResponse, error)
	// T-PRE: Combined threshold decrypt + re-encrypt operation.
	// Takes the partial ECDH shares from all operators, combines them via Lagrange
	// interpolation, decrypts the content key, and re-encrypts it to the reader's public key.
	ThresholdDecryptReencrypt(context.Context, *ThresholdDecryptReencryptRequest) (*ThresholdDecryptReencryptResponse, error)
...
func (UnimplementedFrostServiceServer) DkgRound3(context.Context, *DkgRound3Request) (*DkgRound3Response, error) {
	return nil, status.Error(codes.Unimplemented, "method DkgRound3 not implemented")
}
func (UnimplementedFrostServiceServer) FrostNonce(context.Context, *FrostNonceRequest) (*FrostNonceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FrostNonce not implemented")
}
func (UnimplementedFrostServiceServer) SignFrost(context.Context, *SignFrostRequest) (*SignFrostResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SignFrost not implemented")
}
...
func (UnimplementedFrostServiceServer) PartialEcdh(context.Context, *PartialEcdhRequest) (*PartialEcdhResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PartialEcdh not implemented")
}
func (UnimplementedFrostServiceServer) ThresholdDecryptReencrypt(context.Context, *ThresholdDecryptReencryptRequest) (*ThresholdDecryptReencryptResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ThresholdDecryptReencrypt not implemented")
}
...
func RegisterFrostServiceServer(s grpc.ServiceRegistrar, srv FrostServiceServer) {
	// If the following call panics, it indicates UnimplementedFrostServiceServer was
...
func _FrostService_PartialEcdh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PartialEcdhRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FrostServiceServer).PartialEcdh(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FrostService_PartialEcdh_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FrostServiceServer).PartialEcdh(ctx, req.(*PartialEcdhRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _FrostService_ThresholdDecryptReencrypt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ThresholdDecryptReencryptRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FrostServiceServer).ThresholdDecryptReencrypt(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FrostService_ThresholdDecryptReencrypt_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FrostServiceServer).ThresholdDecryptReencrypt(ctx, req.(*ThresholdDecryptReencryptRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FrostService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "partial_ecdh",
			Handler:    _FrostService_PartialEcdh_Handler,
		},
		{
			MethodName: "threshold_decrypt_reencrypt",
			Handler:    _FrostService_ThresholdDecryptReencrypt_Handler,
		},
	},
