...
// T-PRE: Partial ECDH request.
//
// The operator sends the ephemeral public key from an ECIES ciphertext
// to the local FROST signer. The signer computes S_i = key_share_i * R
// using its FROST secret key share.
type PartialEcdhRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Unique request identifier for correlation.
	RequestId string `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	// The 65-byte uncompressed ephemeral public key extracted from the ECIES ciphertext.
	...
	// The key package containing the signer's secret share.
	// Only the secret_share and identifier fields are used.
	KeyPackage    *KeyPackage `protobuf:"bytes,3,opt,name=key_package,json=keyPackage,proto3" json:"key_package,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PartialEcdhRequest) Reset() {
	*x = PartialEcdhRequest{}
	mi := &file_frost_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PartialEcdhRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PartialEcdhRequest) ProtoMessage() {}

func (x *PartialEcdhRequest) ProtoReflect() protoreflect.Message {
	mi := &file_frost_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PartialEcdhRequest.ProtoReflect.Descriptor instead.
func (*PartialEcdhRequest) Descriptor() ([]byte, []int) {
	return file_frost_proto_rawDescGZIP(), []int{19}
}

func (x *PartialEcdhRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *PartialEcdhRequest) GetEphemeralPublicKey() []byte {
	if x != nil {
...
func (x *PartialEcdhRequest) GetKeyPackage() *KeyPackage {
	if x != nil {
		return x.KeyPackage
	}
	return nil
...
// T-PRE: Partial ECDH response.
//
// Returns the signer's partial ECDH point: S_i = key_share_i * R.
// The operator collects t-of-n of these and uses Lagrange interpolation
// to reconstruct the full ECDH shared secret.
type PartialEcdhResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The 65-byte uncompressed point S_i = key_share_i * ephemeral_pubkey.
	...
	// The signer's identifier (echoed back for correlation).
	Identifier    string `protobuf:"bytes,2,opt,name=identifier,proto3" json:"identifier,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PartialEcdhResponse) Reset() {
	*x = PartialEcdhResponse{}
	mi := &file_frost_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PartialEcdhResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PartialEcdhResponse) ProtoMessage() {}

func (x *PartialEcdhResponse) ProtoReflect() protoreflect.Message {
	mi := &file_frost_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PartialEcdhResponse.ProtoReflect.Descriptor instead.
func (*PartialEcdhResponse) Descriptor() ([]byte, []int) {
	return file_frost_proto_rawDescGZIP(), []int{20}
}

func (x *PartialEcdhResponse) GetPartialEcdhPoint() []byte {
	if x != nil {
...
func (x *PartialEcdhResponse) GetIdentifier() string {
	if x != nil {
		return x.Identifier
	}
	return ""
...
// T-PRE: A partial ECDH share from one operator.
// Used as input to the combined threshold_decrypt_reencrypt RPC.
type PartialEcdhShare struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The 1-based FROST index of the operator that produced this share.
	OperatorIndex uint32 `protobuf:"varint,1,opt,name=operator_index,json=operatorIndex,proto3" json:"operator_index,omitempty"`
	// The 65-byte uncompressed point S_i = key_share_i * ephemeral_pubkey.
	PartialEcdhPoint []byte `protobuf:"bytes,2,opt,name=partial_ecdh_point,json=partialEcdhPoint,proto3" json:"partial_ecdh_point,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *PartialEcdhShare) Reset() {
	*x = PartialEcdhShare{}
	mi := &file_frost_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PartialEcdhShare) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PartialEcdhShare) ProtoMessage() {}

func (x *PartialEcdhShare) ProtoReflect() protoreflect.Message {
	mi := &file_frost_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PartialEcdhShare.ProtoReflect.Descriptor instead.
func (*PartialEcdhShare) Descriptor() ([]byte, []int) {
	return file_frost_proto_rawDescGZIP(), []int{21}
}

func (x *PartialEcdhShare) GetOperatorIndex() uint32 {
	if x != nil {
...
func (x *PartialEcdhShare) GetPartialEcdhPoint() []byte {
	if x != nil {
		return x.PartialEcdhPoint
	}
	return nil
...
// T-PRE: Threshold decrypt and re-encrypt request.
//
// The coordinator sends all collected partial ECDH shares along with
// the sealed content key and the reader's public key. The signer:
// 1. Combines shares via Lagrange interpolation to get S = sk * R
// 2. Derives the AES key via HKDF(R || S) matching ecies crate format
// 3. Decrypts the content key with AES-256-GCM
// 4. Re-encrypts the content key to the reader's public key via ECIES
type ThresholdDecryptReencryptRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The full ECIES ciphertext: [65-byte ephemeral pubkey R] [16-byte nonce] [16-byte tag] [encrypted content key].
	...
	// The reader's public key (33 or 65 bytes) to re-encrypt to.
	...
	// The partial ECDH shares from threshold operators.
	PartialShares []*PartialEcdhShare `protobuf:"bytes,3,rep,name=partial_shares,json=partialShares,proto3" json:"partial_shares,omitempty"`
	// The threshold (t in t-of-n).
	Threshold     uint32 `protobuf:"varint,4,opt,name=threshold,proto3" json:"threshold,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ThresholdDecryptReencryptRequest) Reset() {
	*x = ThresholdDecryptReencryptRequest{}
	mi := &file_frost_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ThresholdDecryptReencryptRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ThresholdDecryptReencryptRequest) ProtoMessage() {}

func (x *ThresholdDecryptReencryptRequest) ProtoReflect() protoreflect.Message {
	mi := &file_frost_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ThresholdDecryptReencryptRequest.ProtoReflect.Descriptor instead.
func (*ThresholdDecryptReencryptRequest) Descriptor() ([]byte, []int) {
	return file_frost_proto_rawDescGZIP(), []int{22}
}

func (x *ThresholdDecryptReencryptRequest) GetSealedContentKey() []byte {
	if x != nil {
...
func (x *ThresholdDecryptReencryptRequest) GetReaderPublicKey() []byte {
	if x != nil {
...
func (x *ThresholdDecryptReencryptRequest) GetPartialShares() []*PartialEcdhShare {
	if x != nil {
		return x.PartialShares
	}
	return nil
}

func (x *ThresholdDecryptReencryptRequest) GetThreshold() uint32 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
// T-PRE: Threshold decrypt and re-encrypt response.
type ThresholdDecryptReencryptResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The content key re-encrypted to the reader's public key (ECIES ciphertext).
	...
	// The decrypted content key (plaintext). For PoC, allows direct delivery
...
func (x *ThresholdDecryptReencryptResponse) Reset() {
	*x = ThresholdDecryptReencryptResponse{}
	mi := &file_frost_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ThresholdDecryptReencryptResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ThresholdDecryptReencryptResponse) ProtoMessage() {}

func (x *ThresholdDecryptReencryptResponse) ProtoReflect() protoreflect.Message {
	mi := &file_frost_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ThresholdDecryptReencryptResponse.ProtoReflect.Descriptor instead.
func (*ThresholdDecryptReencryptResponse) Descriptor() ([]byte, []int) {
	return file_frost_proto_rawDescGZIP(), []int{23}
}

func (x *ThresholdDecryptReencryptResponse) GetReEncryptedKey() []byte {
	if x != nil {
...
func (x *ThresholdDecryptReencryptResponse) GetContentKey() []byte {
	if x != nil {
		return x.ContentKey
	}
	return nil
...
const file_frost_proto_rawDesc = "" +
	...
	"\x10CommitmentsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12/\n" +
	"\x05value\x18\x02 \x01(\v2\x19.common.SigningCommitmentR\x05value:\x028\x01\"\x99\x01\n" +
	"\x12PartialEcdhRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x120\n" +
	"\x14ephemeral_public_key\x18\x02 \x01(\fR\x12ephemeralPublicKey\x122\n" +
	"\vkey_package\x18\x03 \x01(\v2\x11.frost.KeyPackageR\n" +
	"keyPackage\"c\n" +
	"\x13PartialEcdhResponse\x12,\n" +
	"\x12partial_ecdh_point\x18\x01 \x01(\fR\x10partialEcdhPoint\x12\x1e\n" +
	"\n" +
	"identifier\x18\x02 \x01(\tR\n" +
	"identifier\"g\n" +
	"\x10PartialEcdhShare\x12%\n" +
	"\x0eoperator_index\x18\x01 \x01(\rR\roperatorIndex\x12,\n" +
	"\x12partial_ecdh_point\x18\x02 \x01(\fR\x10partialEcdhPoint\"\xda\x01\n" +
	" ThresholdDecryptReencryptRequest\x12,\n" +
	"\x12sealed_content_key\x18\x01 \x01(\fR\x10sealedContentKey\x12*\n" +
	"\x11reader_public_key\x18\x02 \x01(\fR\x0freaderPublicKey\x12>\n" +
	"\x0epartial_shares\x18\x03 \x03(\v2\x17.frost.PartialEcdhShareR\rpartialShares\x12\x1c\n" +
	"\tthreshold\x18\x04 \x01(\rR\tthreshold\"n\n" +
	"!ThresholdDecryptReencryptResponse\x12(\n" +
	"\x10re_encrypted_key\x18\x01 \x01(\fR\x0ereEncryptedKey\x12\x1f\n" +
	"\vcontent_key\x18\x02 \x01(\fR\n" +
	"contentKey*'\n" +
	"\vSigningRole\x12\x0e\n" +
	"\n" +
	"STATECHAIN\x10\x00\x12\b\n" +
	"\x04USER\x10\x012\xfe\x05\n" +
	"\fFrostService\x121\n" +
	...
	"\x18validate_signature_share\x12$.frost.ValidateSignatureShareRequest\x1a\x16.google.protobuf.Empty\"\x00\x12G\n" +
	"\fpartial_ecdh\x12\x19.frost.PartialEcdhRequest\x1a\x1a.frost.PartialEcdhResponse\"\x00\x12r\n" +
	"\x1bthreshold_decrypt_reencrypt\x12'.frost.ThresholdDecryptReencryptRequest\x1a(.frost.ThresholdDecryptReencryptResponse\"\x00B,Z*github.com/lightsparkdev/spark/proto/frostb\x06proto3"
...
var file_frost_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_frost_proto_goTypes = []any{
	...
	(*PartialEcdhRequest)(nil),                // 20: frost.PartialEcdhRequest
	(*PartialEcdhResponse)(nil),               // 21: frost.PartialEcdhResponse
	(*PartialEcdhShare)(nil),                  // 22: frost.PartialEcdhShare
	(*ThresholdDecryptReencryptRequest)(nil),  // 23: frost.ThresholdDecryptReencryptRequest
	(*ThresholdDecryptReencryptResponse)(nil), // 24: frost.ThresholdDecryptReencryptResponse
	nil,                              // 25: frost.KeyPackage.PublicSharesEntry
	nil,                              // 26: frost.FrostSigningJob.CommitmentsEntry
	nil,                              // 27: frost.SignFrostResponse.ResultsEntry
	nil,                              // 28: frost.AggregateFrostRequest.SignatureSharesEntry
	nil,                              // 29: frost.AggregateFrostRequest.PublicSharesEntry
	nil,                              // 30: frost.AggregateFrostRequest.CommitmentsEntry
	nil,                              // 31: frost.ValidateSignatureShareRequest.CommitmentsEntry
	(*common.PackageMap)(nil),        // 32: common.PackageMap
	(*common.SigningCommitment)(nil), // 33: common.SigningCommitment
	(*common.SigningResult)(nil),     // 34: common.SigningResult
	(*emptypb.Empty)(nil),            // 35: google.protobuf.Empty
}
var file_frost_proto_depIdxs = []int32{
	32, // 0: frost.DkgRound2Request.round1_packages_maps:type_name -> common.PackageMap
	32, // 1: frost.DkgRound2Response.round2_packages:type_name -> common.PackageMap
	32, // 2: frost.DkgRound3Request.round1_packages_maps:type_name -> common.PackageMap
	32, // 3: frost.DkgRound3Request.round2_packages_maps:type_name -> common.PackageMap
	25, // 4: frost.KeyPackage.public_shares:type_name -> frost.KeyPackage.PublicSharesEntry
	...
	33, // 8: frost.SigningNonceResult.commitments:type_name -> common.SigningCommitment
	...
	26, // 12: frost.FrostSigningJob.commitments:type_name -> frost.FrostSigningJob.CommitmentsEntry
	33, // 13: frost.FrostSigningJob.user_commitments:type_name -> common.SigningCommitment
	...
	27, // 16: frost.SignFrostResponse.results:type_name -> frost.SignFrostResponse.ResultsEntry
	28, // 17: frost.AggregateFrostRequest.signature_shares:type_name -> frost.AggregateFrostRequest.SignatureSharesEntry
	29, // 18: frost.AggregateFrostRequest.public_shares:type_name -> frost.AggregateFrostRequest.PublicSharesEntry
	30, // 19: frost.AggregateFrostRequest.commitments:type_name -> frost.AggregateFrostRequest.CommitmentsEntry
	33, // 20: frost.AggregateFrostRequest.user_commitments:type_name -> common.SigningCommitment
	0,  // 21: frost.ValidateSignatureShareRequest.role:type_name -> frost.SigningRole
	31, // 22: frost.ValidateSignatureShareRequest.commitments:type_name -> frost.ValidateSignatureShareRequest.CommitmentsEntry
	33, // 23: frost.ValidateSignatureShareRequest.user_commitments:type_name -> common.SigningCommitment
	8,  // 24: frost.PartialEcdhRequest.key_package:type_name -> frost.KeyPackage
	22, // 25: frost.ThresholdDecryptReencryptRequest.partial_shares:type_name -> frost.PartialEcdhShare
	33, // 26: frost.FrostSigningJob.CommitmentsEntry.value:type_name -> common.SigningCommitment
	34, // 27: frost.SignFrostResponse.ResultsEntry.value:type_name -> common.SigningResult
	33, // 28: frost.AggregateFrostRequest.CommitmentsEntry.value:type_name -> common.SigningCommitment
	33, // 29: frost.ValidateSignatureShareRequest.CommitmentsEntry.value:type_name -> common.SigningCommitment
	1,  // 30: frost.FrostService.echo:input_type -> frost.EchoRequest
	3,  // 31: frost.FrostService.dkg_round1:input_type -> frost.DkgRound1Request
	5,  // 32: frost.FrostService.dkg_round2:input_type -> frost.DkgRound2Request
	7,  // 33: frost.FrostService.dkg_round3:input_type -> frost.DkgRound3Request
	11, // 34: frost.FrostService.frost_nonce:input_type -> frost.FrostNonceRequest
	15, // 35: frost.FrostService.sign_frost:input_type -> frost.SignFrostRequest
	17, // 36: frost.FrostService.aggregate_frost:input_type -> frost.AggregateFrostRequest
	19, // 37: frost.FrostService.validate_signature_share:input_type -> frost.ValidateSignatureShareRequest
	20, // 38: frost.FrostService.partial_ecdh:input_type -> frost.PartialEcdhRequest
	23, // 39: frost.FrostService.threshold_decrypt_reencrypt:input_type -> frost.ThresholdDecryptReencryptRequest
	2,  // 40: frost.FrostService.echo:output_type -> frost.EchoResponse
	4,  // 41: frost.FrostService.dkg_round1:output_type -> frost.DkgRound1Response
	6,  // 42: frost.FrostService.dkg_round2:output_type -> frost.DkgRound2Response
	9,  // 43: frost.FrostService.dkg_round3:output_type -> frost.DkgRound3Response
	13, // 44: frost.FrostService.frost_nonce:output_type -> frost.FrostNonceResponse
	16, // 45: frost.FrostService.sign_frost:output_type -> frost.SignFrostResponse
	18, // 46: frost.FrostService.aggregate_frost:output_type -> frost.AggregateFrostResponse
	35, // 47: frost.FrostService.validate_signature_share:output_type -> google.protobuf.Empty
	21, // 48: frost.FrostService.partial_ecdh:output_type -> frost.PartialEcdhResponse
	24, // 49: frost.FrostService.threshold_decrypt_reencrypt:output_type -> frost.ThresholdDecryptReencryptResponse
